/**
 * ============================================================================
 * /api/seasons/[id]/activate — POST (ativar season)
 * ============================================================================
 * POST → adminWrite → CSRF → requireRole(ADMIN) → activateSeason
 * ============================================================================
 */
...
import { activateSeason } from "@/lib/services/league/season.service";
...
export const POST = safeRoute(
  async (_req: NextRequest, ctx: RouteContext) => {
    ...
    const activated = await activateSeason(id, {
